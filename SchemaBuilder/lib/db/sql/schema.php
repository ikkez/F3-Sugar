...
class Schema {
    ...
    public
        $dataTypes = array(
            ...
            'INT16' =>       array('mysql' => 'SMALLINT',
                                  'sqlite2?' => 'integer',
                                  'pgsql|ibm|mssql|sybase|dblib|odbc|sqlsrv' => 'smallint',
            ),
            'INT32' =>      array('sqlite2?|pgsql|sybase|odbc|sqlsrv|imb' => 'integer',
                                  'mysql|mssql|dblib' => 'int',
            ),
            'INT64' =>      array('sqlite2?|pgsql' => 'integer',
            ...
            'VARCHAR128' =>      array('mysql' => 'VARCHAR(128)',
                                  'pgsql|sqlite2?|ibm|mssql|sybase|dblib|odbc|sqlsrv' => 'varchar(128)',
            ),
            'VARCHAR256' =>      array('mysql' => 'VARCHAR(256)',
                                  'pgsql|sqlite2?|ibm|mssql|sybase|dblib|odbc|sqlsrv' => 'varchar(256)',
            ),
            'VARCHAR512' =>      array('mysql' => 'VARCHAR(512)',
                                  'pgsql|sqlite2?|ibm|mssql|sybase|dblib|odbc|sqlsrv' => 'varchar(512)',
            ),
