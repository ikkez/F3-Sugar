...
Cortex requires at least Fat-Free v3.0.7 and PHP 5.3.3. For all of the features, it also requires the F3 [SQL Schema Plugin](https://github.com/ikkez/F3-Sugar/tree/master-v3/SchemaBuilder).
